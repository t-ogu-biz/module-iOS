...
//  WebViewApp
//
//  Created by 小口 哲史 on 2017/11/10.
//  Copyright © 2017年 microwave. All rights reserved.
//

import UIKit

class WebContent_01ViewController: CommonViewController ,UIWebViewDelegate,Browser0perationViewDelegate,UIGestureRecognizerDelegate {
