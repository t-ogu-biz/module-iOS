...
- (id)initWithProgress:(NSString *)title delegate:(id)aDelegate button:(NSString *)button
{
	...
	if( self )
	{
		self.innerProgress = [[UIProgressView alloc] initWithFrame:CGRectMake( 12, 80, 260, 30 )] ;
...
- (id)initWithTable:(NSString *)title message:(NSString *)message delegate:(id)aDelegate tableSource:(id<UITableViewDataSource>)tableSource tableDelegate:(id<UITableViewDelegate>)tableDelegate button:(NSString *)button
{
	...
	if( self )
	{
		self.innerTable = [[UITableView alloc] initWithFrame:CGRectMake( 12 , 80, 260, 200 ) style:UITableViewStylePlain] ;
...
- (id)initWithTextField:(NSString *)title message:(NSString *)message delegate:(id)aDelegate textDelegate:(id<UITextFieldDelegate>)textDelegate placeholder:(NSString*)placeholder button:(NSString *)button
{
    ...
    if( self )
    {
        self.innerTextField = [[UITextField alloc] initWithFrame:CGRectMake( 12, 80, 260, 31 )] ;
...
{
	return [[CustomAlertView alloc] initWithButton:title message:message delegate:delegate button:button] ;
}
...
{
	return [[CustomAlertView alloc] initWithIndicator:title message:message delegate:delegate button:button] ;
}
...
{
	return [[CustomAlertView alloc] initWithProgress:title delegate:delegate button:button] ;
}
...
{
	return [[CustomAlertView alloc] initWithTable:title message:message delegate:delegate tableSource:tableSource tableDelegate:tableDelegate button:button] ;
}
...
{
	return [[CustomAlertView alloc] initWithTextField:title message:message delegate:delegate textDelegate:textDelegate placeholder:placeholder button:button] ;
}
